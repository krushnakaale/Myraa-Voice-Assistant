...
def media_play_pause(args: Dict[str, Any]) -> Dict[str, Any]:
    """Toggle play/pause on PC media (Spotify, YouTube, media player)."""
    _press_vk(VK_MEDIA_PLAY_PAUSE)
    return {"result": "Toggled media play/pause."}


@register("mediaStop")
def media_stop(args: Dict[str, Any]) -> Dict[str, Any]:
    """Stop active media playback on PC."""
    _press_vk(VK_MEDIA_STOP)
    return {"result": "Stopped media playback."}


@register("mediaNext")
def media_next(args: Dict[str, Any]) -> Dict[str, Any]:
    """Skip to next media track."""
    _press_vk(VK_MEDIA_NEXT_TRACK)
    return {"result": "Skipped to next media track."}


@register("mediaPrevious")
def media_previous(args: Dict[str, Any]) -> Dict[str, Any]:
    """Go to previous media track."""
    _press_vk(VK_MEDIA_PREV_TRACK)
    return {"result": "Went to previous media track."}
